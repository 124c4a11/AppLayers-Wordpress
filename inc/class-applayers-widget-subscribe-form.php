<?php
/**
 * Widget API: Applayers_Widget_Text class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see WP_Widget
 */
class Applayers_Widget_Subscribe extends WP_Widget {
  ...
  public function __construct() {
    ...
    parent::__construct( 'text', __( 'Subscribe form' ), $widget_ops, $control_ops );
  }
  ...
  public function widget( $args, $instance ) {
     ...
     */
    $text = apply_filters( 'Applayers_Widget_Subscribe', $text, $instance, $this );
